...
const PRIORITY_STREAMS = [
  {
    ...
    badge: 'HD',
    language: 'English',
    description: 'FIFA World Cup 2026 — Fox Sports HD (All Devices)',
  ...
  {
    id: 330,
    key: 'fifa_cc5_chinese',
    name: 'CC5 Chinese HD',
    match: 'FIFA World Cup 2026 — Live',
    logo: 'CC5',
    badge: 'HD',
    language: 'Chinese',
    description: 'FIFA World Cup 2026 — CC5 Chinese HD',
  ...
  {
    id: 331,
    key: 'fifa_trc_spanish',
    name: 'TRC Spanish HD',
    match: 'FIFA World Cup 2026 — Live',
    logo: 'TRC',
    badge: 'HD',
    language: 'Spanish',
    description: 'FIFA World Cup 2026 — TRC Spanish HD',
    url: 'https://live2.eu-north-1a.cf.dmcdn.net/sec2(YeQREMteainC6pST5rllFsN_JL5MiHvssifTs6bTZaw6vFwm4LbRtYy7jMTfAM_O2egO2auEZowfmhFyeo5jmKLuMWCPPamTf0WvPXXSuHOrRMENjG1FQ-ibQ-KAZfJn)/cloud/3/x9ksaba/s/live-720.m3u8',
    keyId:  null,
    drmKey: null,
  },
  {
